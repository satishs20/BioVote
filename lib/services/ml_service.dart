...
class MLService {
  ...
  void comparision (List loggerFaceData, List? modelData) async {

    double minDist = 999;
    double currDist = 0.0;
    faceMatch = false;
    currDist = _euclideanDistance(modelData, loggerFaceData);
  ...
  void setfaceMatch(value) {
    this.faceMatch = value;
  }
